...
{
    /// <summary>
    /// Generates <see cref="IEnumerable{T}"/> mappings.
    /// </summary>
    public class IEnumerableGenerator : IMappingGenerator
    {
        #region Allocator

        private class Allocator<T> : IMagicBagAllocator<IEnumerable<T>>
        {
            ...
            public IEnumerable<T> CreateInstance( IMagicBag magicBag )
            {
        ...
        public Mapping[] Generate( Mapping[] mappings )
        {
            ...
            foreach( var pair in dictionary )
            {
                ...
                var generatedType = typeof(IEnumerable<>).MakeGenericType(originalMappingFrom);
